...
const VALIDATION_RULES: string[] = [
  'You can only upload your own hours — the email column must be your work email.',
...
@Component({
  imports: [UploadPanel],
  selector: 'app-upload-hours',
  templateUrl: './upload-hours.html',
})
export class UploadHours {
